...
| 3    | [Longest Substring Without Repeating Characters](https://leetcode-cn.com/problems/longest-substring-without-repeating-characters/) | python                                                       | 1.Using set to judge repeating string<br />2.Sliding Window<br />T:$O(n)$ S:$O(k)$ |
