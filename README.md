...
| 23   | [合并K个排序链表](https://leetcode-cn.com/problems/merge-k-sorted-lists/) | 1.[**分治算法**，巧妙在按序两两分治，而不是左右分治](https://leetcode-cn.com/problems/merge-k-sorted-lists/)<br />2. |
| 24   | [两两交换链表中的节点](https://leetcode-cn.com/problems/swap-nodes-in-pairs/) | 1.**指针**，1迭代指针，2位置指针，3前置指针：两种情况：1：头指针交换 2：非头指针交换<br />2.[**指针**](https://leetcode-cn.com/problems/swap-nodes-in-pairs/solution/liang-liang-jiao-huan-lian-biao-zhong-de-jie-di-19/)，额外头指针，普适化，只有非头指针交换，2位置指针，1前置指针<br />3.[**递归**](https://leetcode-cn.com/problems/swap-nodes-in-pairs/solution/liang-liang-jiao-huan-lian-biao-zhong-de-jie-di-19/)，只有头指针交换 |
| 26   | [删除排序数组中的重复项](https://leetcode-cn.com/problems/remove-duplicates-from-sorted-array/) | 1.单**指针**，加pop<br />2.[**双指针**](https://leetcode-cn.com/problems/remove-duplicates-from-sorted-array/solution/shuang-zhi-zhen-shan-chu-zhong-fu-xiang-dai-you-hu/) |
