...
| 6    | [ZigZag Conversion](https://leetcode-cn.com/problems/zigzag-conversion/) | [python](https://github.com/haofengsiji/leetcode-python/blob/master/Qustion%20Code/6.%20ZigZag%20Conversion.py) | 1. [Find index math relation](https://leetcode-cn.com/problems/zigzag-conversion/solution/zhao-gui-lu-by-haofengsiji/)<br />T: $O(n)$ S: $O(n)$ |
